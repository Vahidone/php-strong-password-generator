...
<body>
    ...
    <div class="form-container">
      <form action="index.php" method="POST">
        <div class="input-box mb-3 bg-light.bg-gradient">
          ...
          <input type="number" class="form-control w-25 h-75 bg-white border border-secondary" name="numero" id="numero" required>

          <div class="w-100 text-start mt-3">
            <button class="btn btn-primary me-2 fs-3 ">Invia</button> 
            <button onclick="emptyInput()" class="btn btn-secondary fs-3">Annulla</button>
          </div>
  ...
  <!-- aggiunto una funzione in js per poter svuotare il campo input con il pulsante "Annulla"  -->
  <script>
    function emptyInput() {
